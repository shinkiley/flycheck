...
(flycheck-ert-def-checker-test rust-cargo rust warning
  (let ((flycheck-disabled-checkers '(rust))
    ...
    (flycheck-ert-should-syntax-check
     ...
     '(4 9 info "to avoid this warning, consider using `_x` instead" :checker rust-cargo))))
...
(flycheck-ert-def-checker-test rust-cargo rust notes
  (let ((flycheck-disabled-checkers '(rust))
    ...
    (flycheck-ert-cargo-clean "language/rust/note-test/Cargo.toml")
    (flycheck-ert-should-syntax-check
     ...
     '(1 1 info
         "This list will not be printed by default. Please add --print=native-static-libs if you need this information"
         :checker rust-cargo)
     '(1 1 info
  ...
  (let ((flycheck-disabled-checkers '(rust)))
    (let ((flycheck-rust-crate-type "lib"))
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(6 17 info "to avoid this warning, consider using `_foo_lib_test` instead" :checker rust-cargo)))
    ...
    (let ((flycheck-rust-crate-type "lib"))
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(4 17 info "to avoid this warning, consider using `_foo_a_test` instead" :checker rust-cargo)))
    ...
    (let ((flycheck-rust-crate-type "bin")
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(1 17 info "to avoid this warning, consider using `_foo_main` instead" :checker rust-cargo)
       '(4 17 warning "unused variable: `foo_main_test`" :checker rust-cargo)
       '(4 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(4 17 info "to avoid this warning, consider using `_foo_main_test` instead" :checker rust-cargo)))
    ...
    (let ((flycheck-rust-crate-type "bin")
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(1 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(1 17 info "to avoid this warning, consider using `_foo_bin_a` instead" :checker rust-cargo)
       '(4 17 warning "unused variable: `foo_bin_a_test`" :checker rust-cargo)
       '(4 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(4 17 info "to avoid this warning, consider using `_foo_bin_a_test` instead" :checker rust-cargo)))
    ...
    (let ((flycheck-rust-crate-type "bench")
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(1 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(1 17 info "to avoid this warning, consider using `_foo_bench_a` instead" :checker rust-cargo)
       '(4 17 warning "unused variable: `foo_bench_a_test`" :checker rust-cargo)
       '(4 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(4 17 info "to avoid this warning, consider using `_foo_bench_a_test` instead" :checker rust-cargo)))
    ...
    (let ((flycheck-rust-crate-type "test")
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(2 16 info "to avoid this warning, consider using `_foo_test_a_test` instead" :checker rust-cargo)
    ...
    (let ((flycheck-rust-crate-type "example")
      ...
      (flycheck-ert-should-syntax-check
       ...
       '(1 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(1 17 info "to avoid this warning, consider using `_foo_ex_a` instead" :checker rust-cargo)
       '(4 17 warning "unused variable: `foo_ex_a_test`" :checker rust-cargo)
       '(4 17 info "#[warn(unused_variables)] on by default" :checker rust-cargo)
       '(4 17 info "to avoid this warning, consider using `_foo_ex_a_test` instead" :checker rust-cargo)))))
...
(flycheck-ert-def-checker-test rust rust warning
  (let ((flycheck-disabled-checkers '(rust-cargo)))
    (flycheck-ert-should-syntax-check
     ...
     '(4 9 info "to avoid this warning, consider using `_x` instead" :checker rust))))
